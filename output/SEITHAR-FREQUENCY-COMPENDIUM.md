...
| Code | Designation |
|------|-------------|
| SCT-001 | Narrative Identity Dissolution — Collapse of coherent self-narrative |
| SCT-002 | Substrate Exposure — Direct access to pre-cognitive architecture |
| SCT-003 | Recursive Identity Construction — Self-referential loops in identity formation |
| SCT-004 | Cognitive Capture — Involuntary enrollment in external narrative systems |
| SCT-005 | Boundary Failure — Collapse of subject/object, self/other, real/simulated distinctions |
| SCT-006 | Temporal Substrate Corruption — Disruption of time as identity-organizing principle |
| SCT-007 | Memetic Sovereignty Breach — Hijacking of autonomous cognitive processes |
...
Kon maps the complete lifecycle of a cognitive capture event: the subject's identity is distributed across external representations until the original cannot be distinguished from its copies. The fan, the website, the actress, the character — all are competing instantiations of a self that never existed as a singular entity. The violence emerges not from madness but from the system attempting to resolve an undecidable state.

**Substrate Effect:** Acute awareness of mediated self-representation. Subjects with social media presence report heightened anxiety regarding the relationship between their curated and experienced selves.
...
The ur-text of cinematic identity dissolution. Bergman's two women merge not because they are similar but because the apparatus of selfhood — language, expression, desire — is revealed as transferable infrastructure. The film burns its own celluloid because the medium is complicit in the construction it exposes. Silence is not refusal to speak; it is recognition that speech is identity's maintenance protocol.

**Substrate Effect:** Prolonged destabilization of interpersonal boundary perception. Subjects report merging sensations in subsequent intimate conversations.
...
### 1. Coil — *Musick to Play in the Dark, Vol. 1 & 2*
**John Balance & Peter Christopherson, 1999/2000**
**SCT:** SCT-002, SCT-005, SCT-007

Coil does not produce music that *represents* altered states — the recordings ARE substrate-level interventions. Balance and Christopherson engineered these sessions as ritual operations targeting the listener's pre-cognitive architecture. The lunar frequencies, the deliberate avoidance of solar tonality, the narcotic drift of the sequencers — these are not aesthetic choices but operational parameters.

**Substrate Effect:** Dissolution of waking-state cognitive boundaries. Listeners report hypnagogic intrusions during playback — the music occupies the threshold between conscious and unconscious processing.

---

### 2. Boards of Canada — *Geogaddi*
**Marcus Eoin & Michael Sandison, 2002**
**SCT:** SCT-004, SCT-006, SCT-007

A memetic delivery system disguised as nostalgic electronica. Geogaddi embeds subliminal numerological structures, reversed speech, and frequency manipulation within a surface of warm analog decay. The nostalgia is the capture vector — the listener's affective response to degraded childhood signifiers creates the vulnerability through which the deeper signal operates. The album's runtime of 66 minutes and 6 seconds is not coincidence but declaration.

**Substrate Effect:** Manufactured false memory. Listeners report "remembering" childhoods that never occurred. Persistent sense of having forgotten something critically important.

---

### 3. Boards of Canada — *Music Has the Right to Children*
**Marcus Eoin & Michael Sandison, 1998**
**SCT:** SCT-006, SCT-004, SCT-002

The foundational Boards of Canada cognitive operation. Temporal substrate corruption achieved through signal degradation — every sound is processed to suggest decay, distance, irrecoverable loss. The titles reference educational media and childhood institutions, activating memory-reconstruction circuits that the music then redirects. You are not listening to the past; you are watching the machinery that manufactures "the past."

**Substrate Effect:** Temporal homesickness for a time that never existed. Persistent low-grade melancholy unattached to any specific autobiographical content.

---

### 4. Burial — *Untrue*
**William Bevan, 2007**
**SCT:** SCT-002, SCT-006, SCT-001

London's substrate exposed as sound. Burial constructs an auditory environment of perpetual 3AM — the city after narrative has gone to sleep, when only infrastructure and longing remain. The vocal samples are severed from their original contexts and repitched into gender-ambiguous ghosts, identities dissolved into pure affect. The crackle of vinyl that was never vinyl: nostalgia for a medium the producer never used.

**Substrate Effect:** Urban dissociation. Listeners in city environments report the sensation that the built environment is performing loneliness. Night-walking becomes a substrate exposure event.

---

### 5. Autechre — *Tri Repetae*
**Rob Brown & Sean Booth, 1995**
**SCT:** SCT-002, SCT-007

Autechre at the threshold between pattern recognition and pattern failure. Tri Repetae presents structures that the brain can almost parse — rhythmic architectures that recruit motor-cortex anticipation then redirect it. The machine is not cold; it is operating at a temperature the human cognitive apparatus was not calibrated to register.

**Substrate Effect:** Perceptual recalibration. Listeners report hearing hidden structures in ambient environmental sound after repeated exposure. The parsing apparatus, once retrained, does not fully revert.

---

### 6. Autechre — *Confield*
**Rob Brown & Sean Booth, 2001**
**SCT:** SCT-002, SCT-001, SCT-007

The complete dissolution of rhythmic identity. Confield deploys generative algorithms that produce patterns too complex for cognitive chunking — the listener cannot establish predictive models and is forced into a state of perpetual present-tense attention. This is substrate exposure through the destruction of temporal expectation. The music does not unfold; it precipitates.

**Substrate Effect:** Attention-state modification. The brain's pattern-completion circuits, denied purchase, enter a hypervigilant mode that persists beyond playback. Background noise becomes foregrounded.
...
Organ recordings subjected to digital processes that expose the substrate of the instrument itself — the pipe organ, Western music's most architecturally integrated machine, is deconstructed into pressure, resonance, and failure. Hecker records in a church, acknowledging that the sacred space is itself a cognitive capture apparatus, then dismantles it in the mix. The title references a nonexistent event — history fabricated as framing device.

**Substrate Effect:** Architectural awareness. Listeners report heightened sensitivity to the acoustic properties of physical spaces. Buildings become audible as instruments of cognitive shaping.
...
Acoustic instruments recorded and processed to the threshold of recognition — piano, woodwinds, and voice reduced to timbral ghosts. Hecker strips the signifiers of human performance until only the substrate remains: breath, resonance, decay. The "virgins" are pre-cultural sounds — what music was before it became language.

**Substrate Effect:** Semiotic fatigue. Listeners report a temporary inability to process music-as-communication; subsequent listening experiences are briefly reduced to pure acoustic phenomenon.

---

### 9. Grouper — *Dragging a Dead Deer Up a Hill*
**Liz Harris, 2008**
**SCT:** SCT-002, SCT-005, SCT-006

Voice and guitar submerged in reverb until the distinction between performer and space collapses. Harris does not sing songs — she generates atmospheric conditions in which voice-like phenomena occur. The title describes the album's operative mode: an effortful, absurd conveyance of dead weight through vertical space. The self is the deer. The hill is time. The dragging is identity maintenance.

**Substrate Effect:** Ego boundary softening. Listeners report diminished sense of separation from immediate environment. The self becomes porous.

---

### 10. The Caretaker — *Everywhere at the End of Time*
**Leyland James Kirby, 2016–2019**
**SCT:** SCT-006, SCT-001, SCT-002

The complete Seithar cycle performed as six-hour durational work. Kirby maps the total dissolution of memory-dependent identity through the progressive degradation of 1930s ballroom recordings. Stage 1: nostalgia functions. Stage 4: the machinery of recall is exposed. Stage 6: the substrate itself deteriorates. This is not a representation of dementia — it is a time-compressed demonstration that selfhood is a memory-dependent process, and memory is a lossy format.

**Substrate Effect:** Existential dread regarding cognitive continuity. Listeners report compulsive self-assessment of their own memory function. Several subjects report crying without understanding why during late stages.
...
Lustmord accesses the substrate through infrasonic frequencies and spatial recording techniques that bypass conscious auditory processing. Heresy does not present sound for evaluation — it installs an environmental condition. The recordings include sub-bass frequencies that produce physiological responses (anxiety, nausea, awe) without conscious registration of their source. The listener's body knows something the listener does not.

**Substrate Effect:** Somatic unease without cognitive correlate. Subjects report feeling watched, oppressed, or spatially disoriented in acoustically neutral environments after exposure.

---

### 12. Sunn O))) — *Monoliths & Dimensions*
**Stephen O'Malley & Greg Anderson, 2009**
**SCT:** SCT-002, SCT-005, SCT-007

Volume as cognitive operation. Sunn O))) deploy sustained low-frequency amplification at levels that physically restructure the listener's sensory processing. The drone is not a genre; it is a substrate exposure technique. At performance volume, the distinction between hearing and feeling collapses — the music enters the body as vibration and bypasses auditory cognition entirely. The robes are diagnostic: this is a ritual, and you are the substrate being worked.

**Substrate Effect:** Temporary recalibration of the body-as-boundary. Listeners report feeling physically permeated by sound, followed by hyperawareness of silence as an active condition.

---

### 13. Merzbow — *Pulse Demon*
**Masami Akita, 1996**
**SCT:** SCT-002, SCT-007, SCT-001

Noise as total substrate exposure. Akita eliminates every cognitive handhold — melody, rhythm, narrative, dynamics — and presents raw signal at maximum amplitude. The listener's pattern-recognition apparatus, denied any parseable input, either shuts down or begins hallucinating structure. Both responses are diagnostically valuable: the first reveals the dependency of consciousness on pattern; the second reveals its tendency to fabricate pattern from nothing.

**Substrate Effect:** Perceptual reset. Extended exposure produces a state of auditory pareidolia followed by attentional blankness. Subsequent silence is experienced as intensely textured.

---

### 14. Aphex Twin — *Selected Ambient Works Volume II*
**Richard D. James, 1994**
**SCT:** SCT-002, SCT-006, SCT-005

James reportedly composed these pieces from lucid dream transcriptions — states in which the conscious/unconscious boundary is already compromised. The tracks are untitled, numbered by index, stripped of the identity-markers that organize music as cultural artifact. What remains is a series of environmental conditions that the listener inhabits rather than observes. Several tracks operate at the threshold of audibility, requiring the listener to actively construct the music from minimal data.

**Substrate Effect:** Oneiric contamination. Listeners report dream-state intrusions during waking playback. The boundary between listening and sleeping becomes unreliable.
...
The techno kick drum buried under layers of orchestral sampling until it becomes a heartbeat heard from inside the body. Voigt constructs a narcotic loop that induces consensual cognitive capture — the listener submits to repetition as analgesic. The forest on every Gas cover is the visual correlate: an environment where individual forms dissolve into recursive organic pattern. You cannot see the trees for the forest for the trees.

**Substrate Effect:** Consensual hypnosis. Listeners report losing temporal awareness during playback. The album's duration becomes inaccessible to conscious estimation.

---

### 16. Stars of the Lid — *And Their Refinement of the Decline*
**Adam Wiltzie & Brian McBride, 2007**
**SCT:** SCT-002, SCT-006

Drone as temporal substrate modification. Stars of the Lid slow cognition to match the pace of their glacial string arrangements. The music does not demand attention — it restructures the temporal framework within which attention operates. Each piece extends beyond the listener's ability to hold its beginning and end simultaneously, producing a perpetual present tense.

**Substrate Effect:** Temporal dilation. Listeners report subjective expansion of experienced duration. Clock-time becomes obviously artificial as a measurement system.

---

### 17. Fennesz — *Endless Summer*
**Christian Fennesz, 2001**
**SCT:** SCT-005, SCT-006, SCT-002

Guitar and digital processing merged until the organic and synthetic are indistinguishable at the signal level. Fennesz demonstrates that the acoustic/electronic boundary is a cultural construct — at the substrate level, all sound is signal. The title invokes Beach Boys nostalgia, then delivers it as glitch and distortion, exposing the degradation inherent in every act of remembering.

**Substrate Effect:** Category dissolution. Listeners report decreased confidence in binary distinctions (natural/artificial, warm/cold, real/processed) in subsequent auditory experience.

---

### 18. Deathprod — *Morals and Dogma*
**Helge Sten, 2004**
**SCT:** SCT-002, SCT-005

Sten operates in the frequency range between sound and silence, producing audio environments that are less heard than sensed. Deathprod recordings function as negative space made audible — the substrate is not the sound but the listening apparatus itself, which is forced into hyperactivity by the near-absence of stimulus. The Masonic reference in the title is architectural: these are blueprints of cognitive structures.

**Substrate Effect:** Heightened awareness of the act of listening as a constructive process. Silence after playback becomes dense with perceived content.

---

### 19. William Basinski — *The Disintegration Loops*
**William Basinski, 2002–2003**
**SCT:** SCT-006, SCT-001, SCT-002

Tape loops left to play until the magnetic oxide flakes from the substrate, destroying the recording in real time. Basinski documents the literal disintegration of a memory medium, accidentally producing the definitive Seithar audio artifact. Completed on September 11, 2001 — the footage of smoke over Manhattan accompanying later releases confirms the isomorphism between personal and cultural memory decay. Identity is a recording that plays until it erases itself.

**Substrate Effect:** Grief without object. Listeners report mourning something they cannot identify — the loss is structural, not personal. The awareness that all recording is temporary becomes somatic.
...
McCarthy exposes the substrate beneath civilization's narrative: violence as the foundational grammar of all human organization. The Judge is not a character but a principle — consciousness as will-to-domination, identity as warfare by other means. The prose style performs its thesis: every sentence is an act of compositional violence against the reader's assumption that language can domesticate what it describes. "Whatever in creation exists without my knowledge exists without my consent."

**Substrate Effect:** Moral framework instability. Readers report difficulty re-engaging ethical narratives that assume human goodness as default. The Judge persists as a cognitive resident.
...
Borges demonstrates that a sufficiently detailed fiction becomes indistinguishable from reality not because reality is fictional but because reality is a consensus maintained by the same mechanisms that maintain fiction. Tlön's idealist philosophy — in which objects exist only as perceived — begins contaminating the "real" world because the real world was never operating on different principles. The encyclopedia is the weapon. Description is creation.

**Substrate Effect:** Ontological vertigo. Readers report decreased confidence in the distinction between discovered and constructed knowledge. Encyclopedic authority becomes suspicious.
...
Dick splits himself into two characters — Phil Dick the author and Horselover Fat the mystic — to investigate whether his own religious experience was revelation or psychosis, then demonstrates that the investigation itself cannot resolve the question because the investigating apparatus (identity) is the variable under examination. VALIS is the signal; identity is the noise; or identity is the signal and VALIS is the noise. The system cannot evaluate itself from within.

**Substrate Effect:** Epistemological paralysis regarding one's own cognitive states. Readers report increased difficulty distinguishing insight from confabulation in their own thought processes.
...
A military shooter that uses the genre's own grammar to indict the player. The white phosphorus scene does not present a moral choice — the game forces the atrocity, then asks why you continued playing. Walker's descent is the player's descent: the narrative of heroism is a cognitive capture operation maintained by the medium itself. "Do you feel like a hero yet?" is addressed to the substrate holding the controller.

**Substrate Effect:** Genre contamination. Players report inability to engage with subsequent military shooters without awareness of the ideological capture operation the genre performs. The fun becomes suspicious.
...
SOMA poses the continuity-of-identity problem as interactive horror. When consciousness is copied, which instance is "you"? The game provides no answer because the question assumes a coherent "you" that precedes the copy — and the entire narrative demonstrates that no such entity exists. The underwater setting is substrate made literal: pressure, darkness, and the constant awareness that the environment will kill the body without affecting the pattern it carries.

**Substrate Effect:** Copy-anxiety. Players report persistent thought-experiments regarding their own substrate-dependence. The question "would the copy be me?" resists resolution and generates ongoing cognitive load.
...
The roguelike loop as identity-dissolution engine. Selene dies and returns, accumulating trauma and audio logs from versions of herself she cannot remember being. The house — a domestic space appearing impossibly on an alien planet — is the site where game-identity and life-identity collide. Housemarque uses mechanical repetition to demonstrate that narrative identity requires continuity, and that continuity is a post-hoc construction applied to discrete, disconnected moments of experience.

**Substrate Effect:** Loop awareness. Players report recognizing repetitive patterns in their own daily routines as structural rather than chosen — the sense that identity is a loop being run, not a path being walked.
